...
class OAuth2Validator(RequestValidator):
    ...
    def get_additional_claims(self, request):
        ...
        if oauth2_settings.ADDITIONAL_CLAIMS_FUNCTION:
            ...
            import_module, import_function = ".".join(import_path.split(".")[:-1]), import_path.split(".")[-1]
            additional_claims_function = getattr(importlib.import_module(import_module), import_function)
